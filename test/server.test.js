...
//         expect(responseResult.body).toHaveProperty("host", "Coder Academy");
//         expect(responseResult.body).toHaveProperty("image", "https://pbs.twimg.com/profile_images/1056752759402307584/vFjSXrWY_400x400.jpg");
//         expect(responseResult.body).toHaveProperty("title", "New Test Event");
//         expect(responseResult.body).toHaveProperty("date", "25th December 2023");
//         expect(responseResult.body).toHaveProperty("start", "12:00");
//         expect(responseResult.body).toHaveProperty("finish", "15:00");
//         expect(responseResult.body).toHaveProperty("content", "Captain Holt approves");
//         expect(responseResult.body).toHaveProperty("_id", testEventId);
//     });
//     // UPDATE
